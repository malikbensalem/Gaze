...
function getVars(result) {
  ...
  $("#flag").prop("src", "https://www.countryflags.io/" + sabbr + "/flat/64.png");
...
function getAll() {
  $.ajax({
    ...
    success: function(result) {
      ...
      //covid
      $('#cases').html(result['data']['covid']['new_cases']);
      $('#deaths').html(result['data']['covid']['new_deaths']);
      $('#recovered').html(result['data']['covid']['new_recovered']);
      //weather
      ...
      //currency
      $('#symbol').html(result['data']['currency']['CurrencySymbol'] + " ");
      $('#currency').html(result['data']['currency']['CurrencyName']);
